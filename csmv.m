%This script is written to compute distances from a given set of points to a set of linear segments
%params
%P,R : arrays of coordinates of 2n segment endpoints 
...
%
%returns
%squared_distances_to_segments : an n-by-m matrix whose j-th column 
